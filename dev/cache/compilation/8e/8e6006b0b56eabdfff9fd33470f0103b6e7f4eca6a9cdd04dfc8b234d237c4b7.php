...
/* page-about/test.twig */
class __TwigTemplate_c7cd4ac7725f11feb2e2c870ef188774bc586f199bf9360fb895a0daaef34df0 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("base.twig", "page-about/test.twig", 1);
  ...
  <div id=\"Single";
    ...
    <div class=\"uk-grid-large uk-grid\" uk-grid=\"\">
      ...
      ";
        // line 33
        $this->loadTemplate("sidebar.twig", "page-about/test.twig", 33)->display($context);
        // line 34
        echo "
    </div>
...
";
    ...
    public function block_page_content($context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["single"] ?? null), "content", [], "any", false, false, false, 23)) {
            // line 24
            echo "              ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, ($context["single"] ?? null), "content", [], "any", false, false, false, 24), "page-about/test.twig", 24)->display($context);
            // line 25
            echo "            ";
        } else {
            // line 26
...
", "page-about/test.twig", "C:\\xampp\\htdocs\\static.com\\app\\views\\single\\page-about\\test.twig");
    }
}
