...
/* post.twig */
class __TwigTemplate_6a792db4761b45ea21f08a06db3b610d752771af6a5e434783d42fbe6984c32d extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"uk-grid-large uk-grid\" uk-grid=\"\">
      ...
      ";
        // line 31
        $this->loadTemplate("sidebar.twig", "post.twig", 31)->display($context);
        // line 32
        echo "
    </div>
...
";
    ...
    public function block_page_content($context, array $blocks = [])
    {
        ...
        // line 21
        echo "            ";
        if (twig_get_attribute($this->env, $this->source, ($context["post"] ?? null), "content", [], "any", false, false, false, 21)) {
            // line 22
            echo "              ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, ($context["post"] ?? null), "content", [], "any", false, false, false, 22), "post.twig", 22)->display($context);
            // line 23
            echo "            ";
        } else {
            // line 24
...
", "post.twig", "C:\\xampp\\htdocs\\static.com\\app\\views\\posts\\post.twig");
    }
}
